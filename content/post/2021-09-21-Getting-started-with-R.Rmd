...
```{r, echo=FALSE, include=TRUE, fig.cap="RStudio"}
knitr::include_graphics(here::here("post/2021-09-21-Getting-started-with-R/RStudio01.png"), error = FALSE)
```
...
```{r, echo=FALSE, include=TRUE, fig.cap="RSudio windows"}
knitr::include_graphics(here::here("post/2021-09-21-Getting-started-with-R/RS.png"), error = FALSE)
```
...
```{r, echo=FALSE, include=TRUE, fig.cap="Font Ligature"}
knitr::include_graphics(here::here("post/2021-09-21-Getting-started-with-R/FiraFont.png"), error = FALSE)
```


Fira Code is a free monospaced font containing ligatures for common programming multi-character combinations.

```{r, echo=FALSE, include=TRUE, fig.cap="Fira Font"}
knitr::include_graphics(here::here("post/2021-09-21-Getting-started-with-R/Font.png"), error = FALSE)
```
...
```{r, echo=FALSE, include=TRUE, fig.cap="R Snipp"}
knitr::include_graphics(here::here("post/2021-09-21-Getting-started-with-R/Snippets.png"), error = FALSE)
```
