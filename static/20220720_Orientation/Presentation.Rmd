...
--
.pull-right[.middle[
.f4[ Considering the land area, .red[Australia] (7,741,220 km<sup>2</sup>) is **almost four times** bigger than .green[Greenland] (2,166,086 <sup>2</sup>).]]
...
## Measurement of distance is crucial for human surviaval

- Geosapatial analysis in a branch of surveying

- Surveying: identify relative position of different features

- Then prepare a maps of important features.
...
--
This is defined as the ‘equipotential surface that most closely corresponds to mean sea level’ ('pear-shaped.')

---

## An approximate shape for earth
...
--
It is not possible to represent a 3D object to a single 2D map without loosing information. 
...
- The shape of earth is irregular, and called `Geoid`

- Different ellipsoids are use to approximate earth. 

- Conversion from 3D to 2D map is not possible without loosing information. 
