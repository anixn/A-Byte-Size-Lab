...
## Map help us to identify the relative position of different features.
...
.light-red[.f3[To identify features we need a suitable *co-ordinate reference system (CRS)*]]

---

## Shape of earth not a perfect sphere!
...
## Projections are used to transform 3D spherical surface to 2D on a plane sheet of paper
...
---
## Depending on the agreeable tradeoffs with respect to distortions, a specific projection form is chosen.
...
- Different ellipsoids are use to approximate different region of the earth. 
