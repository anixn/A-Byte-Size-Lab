...
date: "Week 03 & 04: 08-10 & 15-17 August 2022"
output:
...
---
# False Color Images
Images have colors which were recorded in the visible or non-visible parts of the electromagnetic spectrum. 
...
- Ability of a sensor to resolve the energy received in a spectral bandwidth.
...
.pull-left[
Most of the remote sensing systems are multi spectral, using more than one spectral band.

- Spectral resolution of some of the remote sensing systems IRS LISS-III uses 4 bands: (green), (red), (near IR) and 1.55-1.70.
